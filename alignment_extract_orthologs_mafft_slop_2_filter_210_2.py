                ...
                if len(record.alignments)>1:
                    ...
                    if MGG_flag:
                        if len(gene_name_list)==0:
                            only_itself_list.append(sequence_file_id)
                            continue
                        ...
                        no_mgg_list.append(sequence_file_id)
                        break
    if rlength(R_blast_vlaue_list)[0]==0:
        length_0_list.append(sequence_file_id)
...
def extract_ortholog_gene(strain_db_dir_path,contig_path,orthogroup_sequence_path,pav_file_path,filter_lower,ortholog_blast_path_name):
    ...
    length_0_list=[]
    no_mgg_list=[]
    with filter_lower_list_file.open('r+') as filter_lower_list_fl:
        lineList = [line.rstrip('\n') for line in filter_lower_list_fl]
