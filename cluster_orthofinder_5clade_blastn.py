...
ggsave(plot = ptree,filename =paste(result_path,color_num, "_","cluster_blast.png",sep = ""))
ggsave(plot = ptree,filename =paste(result_path,color_num, "_","cluster_blast.svg",sep = ""))
'''
def cluster_blastn(
  pav_file_name,
  clade_set,
...
def write_cluster_result_blastn():
  '''
  write 2 file 
...
def pca_blastn(pav_file_name,clade_id_file_name,out_png_file_name,out_eig_png_file_name):
  '''
  input 1: pav_matrix
...
def cluster_rice_blastn(
  ...
  ggsave(plot = ptree,filename =paste(result_path,"rice_",color_num, "_","cluster_blast.png",sep = ""))
  ggsave(plot = ptree,filename =paste(result_path,"rice_",color_num, "_","cluster_blast.svg",sep = ""))
  }
  '''
