...
def add_header(Reference, Vcf_lines,sample_name):
	...
	final_line = "\t".join(["#CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO",sample_name])
...
if __name__ == "__main__":
	...
	if args.output_header:
		Vcf_lines = add_header(args.reference, Vcf_lines,snp_path.stem)
